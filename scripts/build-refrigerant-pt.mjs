...
const R407C_BAR = {
  bubble: [
    ...
    [25, 9.96], [30, 10.57], [35, 11.22], [40, 11.88], [45, 12.58], [50, 13.3], [55, 14.05],
    [60, 14.83], [65, 15.64], [70, 16.48],
  ],
  dew: [
    [-10, 4.5], [-5, 5.2], [0, 6.0], [5, 6.78], [10, 7.27], [15, 7.79], [20, 8.8],
    [25, 9.34], [30, 9.91], [35, 10.5], [40, 11.12], [45, 11.76], [50, 12.43], [55, 13.13],
    [60, 13.86], [65, 14.62], [70, 15.41],
  ],
};
