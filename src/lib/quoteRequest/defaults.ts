...
export function createEmptyQuoteRequestData(type: QuoteType = 'vesi-ilma'): QuoteRequestData {
  ...
  return {
    ...
    altDevice1DeliveryFeeNet: null,
    altDevice2DiscountPercent: 0,
    altDevice2MarginPercent: 25,
    altDevice2DeliveryFeeNet: null,
    optionAGood: '',
    optionABad: '',
    optionBGood: '',
    optionBBad: '',
...
export function normalizeQuoteRequestData(raw: unknown): QuoteRequestData {
  ...
  return normalizePumpDeviceSelection({
    ...
    installationVehicleAllowance: readStoredNumber(
      record.installationVehicleAllowance,
      base.installationVehicleAllowance,
    ),
    installationVehicleHoursPerBlock: readStoredNumber(
      record.installationVehicleHoursPerBlock,
      base.installationVehicleHoursPerBlock,
    ) || 8,
    ...
    deviceDeliveryFeeNet:
      record.deviceDeliveryFeeNet == null ? null : Number(record.deviceDeliveryFeeNet) || 0,
    ...
    altDevice1DeliveryFeeNet:
      record.altDevice1DeliveryFeeNet == null ? null : Number(record.altDevice1DeliveryFeeNet) || 0,
    ...
    altDevice2DeliveryFeeNet:
      record.altDevice2DeliveryFeeNet == null ? null : Number(record.altDevice2DeliveryFeeNet) || 0,
