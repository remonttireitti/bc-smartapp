/**
 * Seeed XIAO ESP32-C3 + 2× DS18B20 (GPIO4 / D2) → BC-Smartapp temp-monitor-ingest
 *
 * Kirjastot (Arduino Library Manager):
 * - OneWire, DallasTemperature
 *
 * secrets.h: WIFI_*, SUPABASE_URL, DEVICE_KEY
 */

#if __has_include("secrets.h")
#include "secrets.h"
#else
#error "Kopioi secrets_template.h → secrets.h"
#endif
